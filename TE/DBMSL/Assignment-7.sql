...
mysql> insert into library values (107, 'A Thousand Splendid Suns', 'Khaled Houssini', 13.50);
Query OK, 1 row affected (0.02 sec)
...
mysql> create table library_audit (bookid int, bname varchar(50), author varchar(50), price decimal(7,2), action varchar(20));
